...
const PROJECTS_DATA: Project[] = [
  ...
  },
  {
    ...
    category: 'KONUT',
    year: 2025,
    tagline: 'Ankara’da seçkin villa yaşamı',
    description:
      'Müstakil lüks villalar ve modern apartman bloğundan oluşan, Ankara’da tamamlanmış prestijli karma konut projesi — Armada Life konsepti.',
    narrative: [
      ...
      'Özel bahçeli müstakil villalar ile modern daireleri bir arada sunan proje, kapalı site güvenliği ve sosyal donatılarıyla ayrıcalıklı bir yaşam standardı sağlar.',
    ...
    heroImage: {
      ...
      alt: 'Tual Armada — Ankara’da modern villa ve konut projesi',
    },
    galleryImages: [
      { src: img('tual-armada/villa-kule.jpg'), alt: 'Tual Armada villa ve apartman bloğu', label: 'Genel' },
      ...
      { src: img('tual-armada/kule.jpg'), alt: 'Tual Armada apartman bloğu', label: 'Apartman' },
      { src: img('tual-armada/kule2.jpg'), alt: 'Tual Armada apartman cephesi', label: 'Blok' },
    ...
    amenities: [
      ...
      { icon: 'apartment', title: 'Apartman Bloğu', description: 'Modern daireler' },
