...
export default function ContactHero() {
  return (
    <section className="relative w-full h-[65vh] min-h-[400px] overflow-hidden -mt-[72px]">
      ...
      <div className="relative z-20 flex flex-col items-center justify-center h-full text-center px-6 pt-20">
        ...
        <h1 className="font-headline text-5xl md:text-6xl lg:text-7xl font-bold text-white tracking-tighter leading-tight mb-4">
          İletişim
        </h1>
