      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-5 flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3 shrink-0">
          <a href={`tel:${COMPANY.phone}`}
            className="inline-flex items-center gap-1.5 border border-primary text-primary text-xs font-bold tracking-wider uppercase px-5 py-2.5 rounded-xl hover:bg-primary hover:text-on-primary transition-all duration-300">
            <MaterialIcon icon="call" size={16} />
            Ara
          </a>
          <Link href="/iletisim"
            className="inline-flex items-center gap-1.5 bg-primary text-on-primary text-xs font-bold tracking-wider uppercase px-5 py-2.5 rounded-xl hover:bg-primary-dim transition-all duration-300 shadow-primary">
