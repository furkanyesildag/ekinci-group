...
export default function ProjectCarousel() {
  ...
  return (
    <section className="bg-surface-container py-20">
      ...
      {/* Scroll container */}
      <div className="flex gap-6 overflow-x-auto hide-scrollbar snap-x snap-mandatory pl-6 lg:pl-[calc((100vw-80rem)/2+1.5rem)] pr-6 pb-4">
        {projects.map(project => (
          <Link key={project.slug} href={`/projeler/${project.slug}`}
            className="group relative shrink-0 w-[320px] sm:w-[420px] md:w-[480px] snap-start rounded-3xl overflow-hidden shadow-ambient hover:shadow-ambient-xl transition-all duration-500 hover:-translate-y-1">
