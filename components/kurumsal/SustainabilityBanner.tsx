    ...
    <section className="max-w-7xl mx-auto px-6 lg:px-8 pb-20">
      <div className="bg-[#1a1c1a] rounded-[2.5rem] overflow-hidden flex flex-col lg:flex-row min-h-[400px]">
        ...
        <div className="flex-1 p-10 lg:p-16 flex flex-col justify-center">
          ...
          <h2 className="font-headline text-4xl md:text-5xl font-bold text-white tracking-tighter leading-tight mb-6">
            Geleceğe<br />
        ...
        <div className="relative w-full lg:w-1/2 min-h-[280px] lg:min-h-0">
          <Image src={SUST_IMG} alt="Sürdürülebilir inşaat" fill className="object-cover opacity-75" sizes="(max-width:1024px) 100vw, 50vw" />
