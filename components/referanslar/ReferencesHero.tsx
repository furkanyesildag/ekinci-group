  ...
  return (
    <section className="relative overflow-hidden bg-inverse-surface text-white -mt-[72px] pt-32 pb-16 md:pt-40 md:pb-24">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* İstatistik kutuları */}
        <div className="mt-12 md:mt-16 grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-5">
          {REF_STATS.map((s) => (
            <div
              key={s.label}
              className="rounded-2xl border border-white/10 bg-white/[0.04] p-5 md:p-7 text-center backdrop-blur-sm"
            >
              <MaterialIcon icon={s.icon} size={26} className="text-primary-fixed mb-3" />
              <span className="block font-headline text-3xl md:text-4xl font-bold text-white tracking-tight">
                {s.value}
              </span>
